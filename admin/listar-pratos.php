      ...
      while($dados=mysqli_fetch_array($res)){
        ...
        ?>
                  <tr>
                    ...
                    <td><button><a href="editar-pratos.php?idprato=<?php echo $dados ['id']?>">Editar</button></a></td>
                    <td><button><a href="deletar-pratos.php?idprato=<?php echo $dados['id']?>">Deletar</button></a></td>
                  </tr> 
                  <?php } ?> 
              </tbody>
            </table>
