                ...
                ?>
                    ...
                    <div class="cardapio-item-outer bounce-hover small-10 medium-4 columns">
                        <div class="cardapio-item">
                            <a href="prato.php?prato=<?php echo $rows2['codigo']?>">

                                <div class="item-image">
                                    <img src="img/cardapio/<?php echo $rows2['codigo']?>.jpg" alt="<?php echo $rows2['nome']?>" />
                                </div>

                                <div class="item-info">


                                    <div class="title"><?php echo $rows2['nome']?></div>
                                </div>
